...
SELECT codigo_item, codigo_unidade, preco, alteracao_preco FROM item_preco WHERE codigo_item = ANY(sqlc.arg(codigos_itens)::pg_catalog.numeric[]) and codigo_prazo == $1;
